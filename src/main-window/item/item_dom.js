...
const Item_DOM = (function () {
    ...
    const itemTitleClassName = "item-title";
    const itemDateClassName = "item-date";
    const itemCheckBoxClassName = "item-checkbox";
    ...
    const updateItemInfo = (itemNode, newTitle, newDate, newChecked) => {
        let itemTitleNode = itemNode.querySelector("."+itemTitleClassName);
        let itemDateNode = itemNode.querySelector("."+itemDateClassName);
        let itemCheckNode = itemNode.querySelector("."+itemCheckBoxClassName);
        itemTitleNode.textContent = newTitle;
        itemDateNode.textContent = MainWindow.convertDateFromInputToReadFormat(newDate);
        itemCheckNode.checked = newChecked;
    }
    ...
    const createItemCheckBoxNode = (checked) => {
        ...
        checkBoxNode.setAttribute('class', itemCheckBoxClassName);
    ...
    const createItemTitleNode = (title) => {
        ...
        titleNode.setAttribute('class', itemTitleClassName);
    ...
    const createItemDateNode = (date) => {
        ...
        //     <h4 class="item-date">12/12/2024</h4>
        // </div>
        // Container
        ...
        dateTextNode.setAttribute('class', itemDateClassName);
        // Append and send
    ...
    return { isItemNodeChecked, createItemNode, hideItem, showItem, updateItemInfo };
